...
{
	{"Landstalker",				56000,		23000,	2,	2},	// 400
	{"Bravura",					50000,		500,	0,	2},	// 401
	{"Buffalo",					183000,		55000,	2,	2},	// 402
	...
	{"Infernus",				433000,	    76500,	0,	2},	// 411
	{"Voodoo",					76000,		23000,	0,	2},	// 412
	{"Pony",					0,			0,		0,	4},	// 413
	{"Mule", 					0,			0,		0,	3},	// 414
	{"Cheetah",					250000,		54000,	2,	2},	// 415
	...
	{"Previon",					4100,		2000,	1,	2},	// 436
	{"Coach", 					0,			0,		0,	4},	// 437
	{"Cabbie", 					0,			0,		0,	2},	// 438
	{"Stallion",				43000,		13000,	0,	2},	// 439
	{"Rumpo", 					600000,		0,		0,	4},	// 440
	{"RC Bandit", 				0,			0,		0,	1},	// 441
	{"Romero", 					60000,		100,	0,	2},	// 442
	{"Packer", 					0,			0,		0,	3},	// 443
	{"Monster", 				0,			0,		0,	3},	// 444
	{"Admiral",					76000,		23000,	0,	2},	// 445
	{"Squalo", 					5833000,	175000,	0,	6},	// 446
	{"Seasparrow", 				833000,		230000,	0,	5},	// 447
	{"Pizzaboy", 		0,			0,		0,	1},	// 448
	{"Tram", 					0,			0,		0,	4},	// 449
	{"Article Trailer 2", 		0,			0,		0,	1},	// 450
	{"Turismo",					316000,		54000,	2,	2},	// 451
	{"Speeder", 				500000,		150000,	0,	6},	// 452
	{"Reefer", 					0,			0,		0,	6},	// 453
	{"Tropic", 					1600000,	350000,	0,	6},	// 454
	{"Flatbed", 				0,			0,		0,	3},	// 455
	{"Yankee", 					0,			0,		0,	3},	// 456
	{"Caddy", 					0,			0,		0,	1},	// 457
	...
	{"Skimmer", 				0,			0,		0,	5},	// 460
	{"PCJ-600",					35000,		10500,	0,	1},	// 461
	{"Faggio",			    	1000,		300,	0,	1},	// 462
	{"Freeway",					31100,		9350,	1,	1},	// 463
	{"RC Baron", 				0,			0,		0,	1},	// 464
	{"RC Raider", 				0,			0,		0,	1},	// 465
	{"Glendale",				6000000,	28000,	2,	2},	// 466
	{"Oceanic",					115000,		350,	0,	2},	// 467
	{"Sanchez",					18600,		5600,	0,	1},	// 468
	{"Sparrow", 				833000,	250000,	0,	5},	// 469
	{"Patriot", 				0,			0,		0,	2},	// 470
	{"Quad",					11600,		3500,	1,	1},	// 471
	{"Coastguard", 				0,			0,		0,	6},	// 472
	{"Dinghy",					8300,		25000,	0,	6},	// 473
	{"Hermes",					60000,		600,	0,	2},	// 474
	{"Sabre",	            	123000,		37000,	1,	2},	// 475
	{"Rustler", 				0,			0,		0,	5},	// 476
	{"ZR-350",					250000,		75000,	2,	2},	// 477
	{"Walton",					7300,		2200,	0,	2},	// 478
	{"Regina",					450000,		2400,	0,	2},	// 479
	{"Comet",					223000,		67000,	2,	2},	// 480
	...
	{"Baggage", 				0,			0,		0,	1},	// 485
	{"Dozer", 					0,			0,		0,	3},	// 486
	{"Maverick", 				1300000,	410000,	0,	5},	// 487
	{"SAN News Maverick", 		0,			0,		0,	5},	// 488
	{"Rancher",					73000,		26000,	1,	2},	// 489
	...
	{"Sandking", 				433000,	    130000,	1,	2},	// 495
	{"Blista Compact",			116000,		35000,	0,	2},	// 496
	...
	{"Hotring Racer B", 		433000,	    55000,	0,	2}, // 503
	...
	{"Beagle", 					1600000,	500000,	0,	5}, 	// 511
	{"Cropduster", 				1300000,	400000,	0,	5}, 	// 512
	{"Stuntplane", 				1100000,	350000,	0,	5}, 	// 513
	{"Tanker",					0,			0,		0,	3}, 	// 514
	{"Roadtrain", 				0,			0,		0,	3}, 	// 515
	{"Nebula",					900000,		1800,	0,	2}, 	// 516
	{"Majestic",				4100,		2000,	0,	2}, 	// 517
	{"Buccaneer",				7600,		2300,	0,	2}, 	// 518
	{"Shamal", 					2500000,	750000,	0,	5}, 	// 519
	{"Hydra", 					0,			0,		0,	5}, 	// 520
	{"FCR-900",					36600,		11000,	0,	1}, 	// 521
	{"NRG-500", 				118000,		35400,	2,	1}, 	// 522
	{"HPV1000",					32000,		320,	0,	1}, 	// 523
	{"Cement Truck", 			0,			0,		0,	3}, 	// 524
	{"Towtruck", 				0,			0,		0,	2}, 	// 525
	{"Fortune",					4700,		2000,	0,	2}, 	// 526
	{"Cadrona",					4400,		2000,	0,	2}, 	// 527
	{"FBI Truck", 				0,			0,		0,	2},	// 528
	{"Willard",					250000,		2500,	0,	2},	// 529
	{"Forklift", 				0,			0,		0,	1}, 	// 530
	{"Tractor", 				0,			0,		0,	3}, 	// 531
	{"Combine Harvester", 		0,			0,		0,	3}, 	// 532
	{"Feltzer",					46000,		14000,	1,	2}, 	// 533
	{"Remington",			    62000,		18700,	1,	2}, 	// 534
	{"Slamvan",					70000,		21000,	1,	2}, 	// 535
	{"Blade",					66000,		20000,	1,	2}, 	// 536
	{"Freight (Train)", 		0,			0,		0,	1}, 	// 537
	{"Brownstreak (Train)", 	0,			0,		0,	1}, 	// 538
	{"Vortex", 					0,			0,		0,	1}, 	// 539
	{"Vincent",					780000,		1800,	0,	2}, 	// 540
	{"Bullet",					316000,		42000,	2,	2}, 	// 541
	{"Clover",					3500,		2000,	0,	2}, 	// 542
	{"Sadler", 					5400,		2000,	0,	2}, 	// 543
	{"Firetruck LA", 			0,			0,		0,	3}, 	// 544
	{"Hustler", 				3800, 		2000,	0,	2}, 	// 545
	{"Intruder",				5100,		2000,	0,	2}, 	// 546
	{"Primo",					4500,		2000,	0,	2}, 	// 547
	{"Cargobob", 				0, 			0,		0,	5},	// 548
	{"Tampa",					3200,		2000,	0,	2},	// 549
	{"Sunrise",					90000,		27000,	0,	2}, 	// 550
	...
	{"Jester",					183000,		55000,	1,	2}, 	// 559
	{"Sultan",					166000,		18000,	1,	2}, 	// 560
	{"Stratum",					210000,		600,	0,	2},	// 561
	{"Elegy",					150000,	    7300,	2,	2}, 	// 562
	{"Raindance", 				0,			0,		0,	5}, 	// 563
	{"RC Tiger", 				0,			0,		0,	1}, 	// 564
	{"Flash",					48000,		1700,	0,	2}, 	// 565
	{"Tahoma",					270000,		27000,	0,	2}, 	// 566
	{"Savanna",					70000,		21000,	0,	2}, 	// 567
	...
	{"Wayfarer",				32000,		9600,	0,	1}, 	// 586
	{"Euros",					140000,		42000,	0,	2}, 	// 587
	{"Hotdog", 					0,			0,		0,	3}, 	// 588
	{"Club",					100000,	    30000,	0,	2}, 	// 589
